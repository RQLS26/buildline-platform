namespace Buildline.Platform.Categories.Domain.Model;

/// <summary>
///     Domain error codes emitted by the Categories bounded context.
/// </summary>
/// <remarks>
...
public enum CategoriesError
{
    ...
    /// <summary>
    ///     An unexpected failure occurred in the Categories bounded context.
    /// </summary>
    InternalServerError
}
